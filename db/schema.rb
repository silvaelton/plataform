...
ActiveRecord::Schema.define(version: 20150710150929) do
  ...
  add_index "helpdesk_qualifications", ["order_service_id"], name: "index_helpdesk_qualifications_on_order_service_id", using: :btree
